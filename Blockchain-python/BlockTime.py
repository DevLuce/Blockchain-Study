...
print("금일 생성된 블록")
cur_milli_time = str(round(time.time() * 1000))
url = 'https://blockchain.info/blocks/'+ cur_milli_time +'?format=json'
...
print("5분 이내 내 거래가 Mining 될 확률 = %.2f (%s)" % (p*100, '%'))